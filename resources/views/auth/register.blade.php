            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="registerForm" action="{{ url('register/'.session('register_role')) }}">
                        ...
                        @if(session('register_role', 'parent') == 'parent')
                        <!-- add parent -->
                        <div class="form-group{{ $errors->has('student_id') ? ' has-error' : '' }}">
                            <label for="student_id" class="col-md-4 control-label">* @lang('Student Name')</label>
                            <div class="col-md-6">
                                    <input type="text" id='search' class="form-control" name="student_id" autocomplete="true">
                        ...
                        <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="group" type="text" class="form-control" name="group" value="{{ old('group') }}" placeholder="@lang('Science, Arts, Commerce,etc.')">
...
<script type="text/javascript">
    $('#search').on('keyup', function() {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://localhost:8000/register/search',
            data: {
                'search': $value
            },
